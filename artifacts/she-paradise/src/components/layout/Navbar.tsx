...
export function Navbar() {
  ...
  return (
    <>
      ...
      {/* Mobile menu — rendered as a sibling outside <header> so it is never
          trapped inside the header's backdrop-filter stacking/containing context.
          This is the correct fix for iOS Safari where backdrop-filter on a parent
          makes position:fixed children relative to that parent instead of viewport. */}
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="fixed inset-0 bg-background z-[45] flex flex-col items-center justify-center"
          >
